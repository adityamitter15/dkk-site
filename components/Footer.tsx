      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 mb-10">
          ...
          <div>
            ...
            <Link
              href="/contact"
              className="inline-block px-5 py-2.5 bg-[#a8201a] text-white text-sm font-semibold uppercase tracking-wide hover:bg-[#c62828] transition-colors rounded-sm"
            >
              Contact Us
            </Link>
            <a
              ...
              className="mt-3 inline-flex items-center gap-2 text-xs text-gray-400 hover:text-white transition-colors"
            >
