          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 border border-white/15 text-white text-sm font-semibold uppercase tracking-wide hover:border-whatsapp hover:text-whatsapp transition-colors rounded-sm"
              >
