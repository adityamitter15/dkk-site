        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3">
              ...
              <span aria-hidden="true" className="hidden lg:block basis-full h-0 lg:-mt-3" />
              <TrackedOutbound
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-whatsapp text-night hover:bg-whatsapp/90 text-sm font-semibold uppercase tracking-wide transition-colors rounded-sm"
              >
              ...
              <TrackedOutbound
                ...
                track="/go/email"
                className="hidden lg:inline-flex items-center gap-2 px-5 py-2.5 border border-white/15 text-white text-sm font-semibold uppercase tracking-wide hover:border-white/40 transition-colors rounded-sm"
              >
            ...
            <div className="mt-4 flex gap-4">
              <TrackedOutbound
                ...
                className="inline-flex items-center gap-2 text-instagram hover:text-white text-xs uppercase tracking-widest transition-colors"
              >
              ...
              <TrackedOutbound
                ...
                className="inline-flex items-center gap-2 text-facebook hover:text-white text-xs uppercase tracking-widest transition-colors"
              >
