...
export const metadata: Metadata = {
  title: "Links",
  description: "Useful links and resources — DKK clubs, martial arts instructors, authors, and Goju Ryu resources.",
};
...
const linkGroups = [
  {
    category: "DKK Clubs",
    links: [
      { title: "DKK London — Instagram", description: "Follow DKK London on Instagram for training news, photos and updates.", href: "https://www.instagram.com/dkklondon" },
      { title: "DKK Bristol", description: "Our sister club run by Shihan Dan Lewis — Bristol Combat Goju Ryu.", href: "#" },
    ...
    <>
      <section className="relative pt-32 pb-20 bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-['Bebas_Neue'] text-6xl sm:text-7xl lg:text-8xl text-white tracking-wide leading-none mb-6">Links</h1>
      ...
      <section className="py-16 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-x-12 gap-y-10 max-w-5xl">
            {linkGroups.map((group) => (
              <div key={group.category}>
                <h3 className="text-[#c0392b] text-xs font-bold uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                  <span className="w-4 h-px bg-[#c0392b]" />
                  {group.category}
                </h3>
                <div className="space-y-2">
                  {group.links.map((link) => (
                    <a
                      ...
                      className={`flex items-start justify-between gap-4 p-4 bg-[#111] border rounded-sm transition-all duration-200 group ${
                        link.href !== "#"
                          ? "border-white/5 hover:border-[#c0392b]/40 cursor-pointer"
                    ...
                    >
                      <div>
                        <p className="text-white text-sm font-medium flex items-center gap-2">
                          {link.title}
                          {link.href !== "#" && <ExternalLink size={11} className="text-gray-600 group-hover:text-[#c0392b] transition-colors" />}
                        </p>
          ...
          <p className="text-gray-700 text-xs mt-10 max-w-xl">
            Links marked as unavailable (#) have not yet been confirmed — contact us if you know the correct URL. DKK London is not responsible for the content of external sites.
          </p>
        </div>
      </section>
    </>
