...
function MemberCard({ member, dan }: { member: Member; dan: string }) {
  ...
  return (
    <div className="bg-[#141311] border border-white/5 hover:border-[#a8201a]/30 transition-all duration-300 rounded-sm overflow-hidden group">
      {/* Image area */}
    ...
    <>
      <section className="relative pt-40 pb-28 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <SafeImage src="/images/Club/grading-group-red.JPG" alt="" fill className="object-cover object-center opacity-20" />
        </div>
      ...
      <section className="py-16 bg-[#0f0e0c]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            ...
            <div className="grid lg:grid-cols-3 gap-0 bg-[#141311] border border-[#a8201a]/20 rounded-sm overflow-hidden">
