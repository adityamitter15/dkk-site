...
/**
 * A real route behind the Google reviews link, so the virtual page view
...
export const metadata: Metadata = {
  title: "Reading Our Google Reviews",
  description: "Taking you to the DKK London Google listing to read reviews.",
  robots: { index: false, follow: true },
  alternates: { canonical: "/contact" },
};

export default function GoGoogleReviewsPage() {
  return (
    <section className="min-h-[70svh] flex items-center justify-center bg-night px-4 py-28">
      <div className="max-w-lg text-center">
        <Star className="text-gold fill-gold mx-auto mb-6" size={48} aria-hidden="true" />
        <h1 className="font-display text-4xl sm:text-5xl tracking-wide text-white mb-4">
          Reading our Google reviews
        </h1>
        <p className="text-gray-400 leading-relaxed mb-8">
          The DKK London Google listing should have opened in a new tab.
        </p>
