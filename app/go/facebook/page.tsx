...
/**
 * A real route behind the Facebook link, so the virtual page view
...
export const metadata: Metadata = {
  ...
  description: "Taking you to Daigaku Karate Kai London on Facebook.",
  robots: { index: false, follow: true },
  alternates: { canonical: "/contact" },
};

export default function GoFacebookPage() {
  return (
    <section className="min-h-[70svh] flex items-center justify-center bg-night px-4 py-28">
      <div className="max-w-lg text-center">
        <Facebook className="text-brand mx-auto mb-6" size={48} aria-hidden="true" />
        <h1 className="font-display text-4xl sm:text-5xl tracking-wide text-white mb-4">
          Opening Facebook
        </h1>
        <p className="text-gray-400 leading-relaxed mb-8">
          Facebook should have opened in a new tab. If nothing happened, carry on below.
        </p>
