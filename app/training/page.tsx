...
export default function TrainingPage() {
  return (
    <>
      {/* Hero — full-bleed with grappling image */}
      <section className="relative pt-40 pb-28 overflow-hidden">
        <div className="absolute inset-0 bg-black" />
        <div className="absolute inset-0">
          <SafeImage src="/images/Gavheadlock4.jpg" alt="" fill className="object-cover object-top opacity-20" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="inline-flex items-center gap-2 text-[#c0392b] text-xs font-bold uppercase tracking-[0.35em] mb-5">
          ...
          <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
            <div>
              ...
              <div className="space-y-3 mb-8">
                {[
                  ...
                  <div key={session.day} className="flex items-center gap-5 p-6 bg-[#111] border-l-2 border-l-[#c0392b] border-y border-r border-white/5 rounded-sm">
                    <Clock className="text-[#c0392b] flex-shrink-0" size={22} />
                    <div>
              ...
              <div className="flex gap-4 items-start p-5 bg-[#111] border border-white/5 rounded-sm hover:border-white/10 transition-colors">
            ...
            <div className="relative">
              <div className="aspect-[4/3] relative rounded-sm overflow-hidden bg-[#111]">
                <SafeImage src="/images/Gavheadlock4.jpg" alt="DKK training — close-quarter grappling" fill className="object-cover object-top" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
                <div className="absolute bottom-4 left-4">
                  <p className="text-[#c0392b] text-xs uppercase tracking-widest">Close-Quarter Combat</p>
                  <p className="text-white font-['Bebas_Neue'] text-lg tracking-wide">Every session. Every week.</p>
                </div>
              </div>
              <div className="absolute -bottom-3 -right-3 w-full h-full border border-[#c0392b]/25 rounded-sm -z-10" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-start">
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={item.title} className="flex gap-4 p-4 bg-[#111] border border-white/5 hover:border-[#c0392b]/30 hover:-translate-y-0.5 transition-all duration-300 rounded-sm group">
                    <div className="w-0.5 flex-shrink-0 bg-[#c0392b]/30 group-hover:bg-[#c0392b] rounded-full transition-colors" />
                    <div>
            ...
            <div className="space-y-4 lg:pt-16">
              <div className="relative rounded-sm overflow-hidden bg-[#111]" style={{ aspectRatio: "340/359" }}>
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <p className="text-[#c0392b] text-[10px] uppercase tracking-[0.2em] mb-0.5">Hojo Undo</p>
              ...
              <div className="relative rounded-sm overflow-hidden bg-[#111]" style={{ aspectRatio: "340/280" }}>
                ...
                <div className="absolute bottom-4 left-4">
                  <p className="text-[#c0392b] text-[10px] uppercase tracking-[0.2em] mb-0.5">Nage Waza</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-14 items-center">
            <div className="lg:col-span-3">
              ...
              <div className="space-y-3 mb-8">
                {[
                  ...
                  { icon: HelpCircle, title: "New Students Welcome", body: "No fee to watch or try your first class. No uniform needed. Adults of all experience levels — complete beginners to black belts." },
                ].map((item) => (
                  <div key={item.title} className="flex gap-4 items-start p-5 bg-[#111] border border-white/5 hover:border-[#c0392b]/30 hover:-translate-y-0.5 transition-all duration-300 rounded-sm">
                    <div className="w-9 h-9 rounded-sm bg-[#c0392b]/10 border border-[#c0392b]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <item.icon className="text-[#c0392b]" size={16} />
                    </div>
                    <div>
            ...
            <div className="lg:col-span-2 relative">
              <div className="relative rounded-sm overflow-hidden bg-[#111]" style={{ aspectRatio: "3/4" }}>
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <p className="text-[#c0392b] text-xs uppercase tracking-widest mt-0.5">Shihan Mulholland · 7th Dan</p>
                </div>
              </div>
              <div className="absolute -bottom-3 -right-3 w-full h-full border border-[#c0392b]/20 rounded-sm -z-10" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#c0392b]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link
            href="/contact"
            className="px-8 py-4 bg-white text-[#c0392b] font-bold uppercase tracking-wider text-sm hover:bg-gray-100 transition-colors rounded-sm flex-shrink-0 inline-flex items-center gap-2"
          >
